...
clear
echo
echo $red"          Proses install selesai dalam waktu 5 detik"
echo $red"            antih bae juluk bro.. sabar.. :v("   
sleep 1
echo '''\a
\033[34;1m                              _
\033[34;1m                             / |
...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR  :  Rr  "$i"                    "
echo $i""$pu"  WhatsApp:  0819172xxxxx"$i"                "
echo $i""$pu"  GMAIL   :  ronydfde@ymail.com"$i"     "
echo $i""$pu"  YOUTUBE :  YouTube"$i"                 "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $i"Silahkan di pakai semoga bermanfaat"
sleep 2
echo $pur"Bila Ada Kesalahan Mohon Dimaklumi"
sleep 2
echo $ku"Facebook :"$i" xxx"
echo $ku"YouTube  :"$i" xxx"
echo $ku"WhatsApp :"$i" xxxx"
sleep 2
echo $pur"---"
sleep 2
echo $pur"Terima Kasih"
exit
fi
